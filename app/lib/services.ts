...
export const SERVICES: SalonService[] = [
  ...
  { name: "Women's Haircut and Style", slug: makeSlug('womens haircut and style'), category: 'womens-haircuts-styling', priceFrom: '$50+' },
  { name: 'Dry Cut', slug: makeSlug('dry cut'), category: 'womens-haircuts-styling', priceFrom: '$40+' },
  { name: "Kid's Haircut", slug: makeSlug('kids haircut'), category: 'womens-haircuts-styling', priceFrom: '$35+' },
  { name: 'Shampoo and Style', slug: makeSlug('shampoo and style'), category: 'womens-haircuts-styling', priceFrom: '$35+' },
